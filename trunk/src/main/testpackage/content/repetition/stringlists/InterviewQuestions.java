...
public enum InterviewQuestions implements StringTypeInterface {
    ...
    JUNIOR_JAVA_WEB_DESKTOP(getJuniorJavaWebDesktop()), INTERMEDIATE_JAVA_DESKTOP(getIntermediateJavaDesktop()),
    INTERMEDIATE_JAVA_WEB_DESKTOP(getIntermediateJavaWebDesktop()), SENIOR_JAVA_WEB_DESKTOP(getSeniorJavaWebDesktop()),
    ...
    private static class StringListHolder {
        ...
        public static String[] intermediateJavaDesktop = {
                ...
                "4Design - OOD:Architectural Patterns: MVVM (.NET Desktop Profile)",
        ...
        public static String[] intermediateJavaWebDesktop = {
                ...
                "dDesign - OOD:Architectural Patterns: MVVM (.NET Desktop Profile)",
