...
public enum InterviewQuestions implements StringTypeInterface {
    ...
    JUNIOR_JAVA_WEB_DESKTOP(getJuniorJavaWebDesktop()), SENIOR_JAVA_WEB_DESKTOP(getSeniorJavaWebDesktop()),
    ...
    private static class StringListHolder {
        ...
        public static String[] juniorJavaWebDesktop = {
                "Java:Declare Classes: Source file declaration",
                "Java:Declare Classes: Class declarations and modifiers",
                "Java:Declare interfaces: Declare interfaces",
                "Java:Declare class members: Access modifiers",
                "Java:Declare class members: Constructor declarations",
                "Java: If and switch statements",
                "Java:Loops and Iterators: while, do and for loops",
                "Java:Loops and Iterators: break and continue",
                "Java:Handling exceptions: using try and catch",
                "Java:Handling exceptions: using finally",
                "Java:Handling exceptions: propagating uncaught exception",
                "Java:Handling exceptions: common exception types (checked and unchecked)",
                "OOP && OOD:Basic OOP concepts: polymorphism",
                "OOP && OOD:Basic OOP concepts: inheritance",
                "OOP && OOD:Basic OOP concepts: incapsulation",
                ...
                "Design - OOD: Separation of concerns principle",
                "Design - OOD: Single responsibility principle",
                ...
                "Construction - Language - Java:Java7 features: String literals in switch statements",
                "Construction - Language - Java:Java7 features: Underscores in literals to improve code readability",
                "Construction - Language - Java:Java7 features: try-with-resources block and exception handling",
                "Construction - Language - Java:Java7 features: Catching multiple exception types",
                "Construction - Language - Java:Java7 features: Rethrowing exceptions in Java 7",
                "Construction - Language - Java:Java7 features: Using the diamond operator for constructor type inference",
                "Construction - Language - Java:Java7 features: Using the @SafeVarargs annotation",
                ...
                "Construction - SQL: DDL, DML, DCL understanding",
                ...
                "Construction - DB Access - Java: Processing SQL Statements with JDBC:Establishing a Connection, Using Statements and Prepared Statements, Retrieving and Modifying Values from Result Sets, Using Transactions",
                "Construction - DB Access - Java: Understanding object/relational mapping concepts",
                "Construction - DB Access - Java: JPA: EntityManager, Persistence Context, Persistence Unit and EntityManagerFactory concepts",
                "Construction - DB Access - Java:JPA Object-Relational Mapping: Annotations for Object/Relational Mapping",
                "Construction - DB Access - Java:JPA Object-Relational Mapping: Mapping to a Table",
                "Construction - DB Access - Java:JPA Object-Relational Mapping: Mapping Simple Types",
                "Construction - DB Access - Java:JPA Object-Relational Mapping: Mapping the Primary Key",
                "Construction - DB Access - Java:JPA Object-Relational Mapping: Mapping Relationships (Unidirectional, Bidirectional, Many-to-One, One-to-One, Many-to-Many)",
                "Construction - DB Access - Java:JPA Object-Relational Mapping: Embedded Objects",
                "Construction - DB Access - Java:JPA Object-Relational Mapping: Collection Mapping",
                "Construction - DB Access - Java:Entity Operations basics: Entity Instance Creation",
                "Construction - DB Access - Java:Entity Operations basics: Persisting an Entity Instance",
                "Construction - DB Access - Java:Entity Operations basics: Entity removal",
                ...
                "Configuration Management: VCS (Version Control Systems): Creating, discovering and breaking locks (if supported)",
                "Construction - Web UI:JavaScript: Variables",
                ...
                "Construction - Web server applications - Java:Generating the Server Response: HTTP Response Headers Topics in This Chapter",
                "Construction - Web server applications - Java:Handling Cookies",
                "Construction - Web server applications - Java:JAXP: SAX2 / DOM",
                "Construction - Java Enterprise Essentials:JEE platform components",
                "Construction - Java Enterprise Essentials:Java Application Server (one of: Tomcat/JBoss/Glassfish/etc):start/stop AS",
                "Construction - Java Enterprise Essentials:Java Application Server (one of: Tomcat/JBoss/Glassfish/etc):Deploy/Undeploy application",
                "Construction - Java Enterprise Essentials:Java Application Server (one of: Tomcat/JBoss/Glassfish/etc):Monitor app state: console/logs",
                "Construction - Java Enterprise Essentials:Manifest file",
                "Construction - Java Enterprise Essentials:Deployment packaging (ear, war, jar)",
                "Construction - Java Enterprise Essentials:Dependency Injection (aka DI): injection points (Java EE/Spring)",
                "Construction - Java Enterprise Essentials:Bean validation: concept, buld-in constraints",
                "Construction - Java Enterprise Essentials:DI containers (Spring/Google Guice/EJB3): concepts",
                "Construction - Java Enterprise Essentials:EJB:EJB component types",
                "Construction - Java Enterprise Essentials:EJB:Container services",
                "Construction - Java Enterprise Essentials:Spring:Spring building blocks",
                "Construction - Java Enterprise Essentials:Spring:IoC and DI in Spring",
                "Construction - Spring MVC - Java:DispatcherServlet Processing Sequence",
                "Construction - Spring MVC - Java:Spring MVC architecture diagram",
                "Construction - Spring MVC - Java:Request flow in Spring MVC",
                "Construction - Spring MVC - Java:Spring: Create and configure your own Controller",
                "Construction - JSF:JSF configuration and life cycle",
                "Construction - JSF:Running Sample App",
                "Construction - JSF:Basic Structure of Facelet Pages and Managed Beans",
                "Construction - JSF:faces-config.xml (navigation rules and bean declaration)",
                "Construction - JSF:JSF HTML Tags",
                "Construction - JSF:Basic form validation"
        };
        ...
        public static String[] seniorJavaWebDesktop = {
                ...
                "Java:Collections:Collections and Arrays",
                "Java:Using collections API:LinkedList",
                "Java:Generic types:Polymorphism and generics",
                "Java:Generic types:Generics methods",
                "Java:Inner classes:reference outer instance from within inner class",
                "Java:Method local inner classes:local method variables in inner classes",
                ...
                "OOP && OOD:Purpose of OOP",
                "OOP && OOD:Coupling and Cohesion",
                "OOP && OOD:Information expert (GRASP)",
                "OOP && OOD:Interface segregation principle",
                "OOP && OOD:Single responsibility principle",
                "OOP && OOD:Examples of usage interfaces and abstract classes",
                "OOP && OOD:Dependency Inversion",
                "OOP && OOD:Open/Closed Principle",
                "OOP && OOD:Composite Reuse",
                "OOP && OOD:Acyclic Dependencies Principle",
                "OOP && OOD:Immutability",
                "OOP && OOD:GOF Patterns:Why we need patterns",
                "OOP && OOD:GOF Patterns:At least three from each category",
                "OOP && OOD:GOF Patterns:Examples from JDK (at least 3)",
                ...
                "SQL:Nulls",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Abiliton SDLC",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Scrum:Planning",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Scrum:Reporting",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Scrum:Scaling projects",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Agile Unified Process",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Extreme Programming (XP):Concepts",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Extreme Programming (XP):Practices",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Extreme Programming (XP):Planning",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Extreme Programming (XP):Testing",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Extreme Programming (XP):Test-driven development",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Agile:Feature Driven Development",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Rational Unified Process (RUP):Key features and best practices",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Rational Unified Process (RUP):Static structure",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Rational Unified Process (RUP):Dynamic structure",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Rational Unified Process (RUP):Use-Case-Driven process",
                "Engineering Management - Process Planning (SDLC):Software Development Methodologies:Lean software development:Kanban",
                "Engineering Management - Process Planning (SDLC):Engineering Process Planning:Evaluating technical feasibility",
                "Engineering Management - Process Planning (SDLC):Engineering Process Planning:Defining unit-testing process",
                "Engineering Management - Process Planning (SDLC):Engineering Process Planning:Defining code review process",
                "Engineering Management - Estimation:Cone of Uncertainty ",
                "Engineering Management - Estimation:Source of Estimation Errors ",
                "Engineering Management - Estimation:Diseconomies of Scale ",
                "Engineering Management - Estimation:Count, Compute, Judge techniques ",
                "Engineering Management - Estimation:Delphi method",
                "Engineering Management - Estimation:Challenges with Estimating Size ",
                "Engineering Management - Estimation:Challenges with Estimating Effort ",
                "Engineering Management - Estimation:Challenges with Estimating Schedule ",
                "Engineering Management - Estimation:Story based scope definition: scoping project, release planning  ",
                "Engineering Management - Estimation:Documenting and presenting estimation results ",
                "Engineering Management - Estimation:PERT analysis ",
                "Requirements - Software Requirements:System requirements",
                "Requirements - Software Requirements:Non-functional requirements",
                "Requirements - Software Requirements:Product champion ",
                "Requirements - Software Requirements:User classes and their characteristics ",
                "Requirements - Software Requirements:Software Quality Attributes ",
                "Requirements - Software Requirements:Assumptions, constraints and their roles ",
                "Requirements - Software Requirements:Requirements Elicitation Techniques:Focus Groups",
                "Requirements - Software Requirements:Requirements Elicitation Techniques:Interface Analysis",
                "Requirements - Software Requirements:Requirements Elicitation Techniques:Observation",
                "Requirements - Software Requirements:Requirements Elicitation Techniques:Requirements Workshops",
                "Requirements - Software Requirements:Requirements Elicitation Techniques:Prototyping",
                "Requirements - Software Requirements:Basic Modeling techniques:Data dictionary and glossary",
                "Requirements - Software Requirements:Basic Modeling techniques:Data flow diagrams",
                "Requirements - Software Requirements:Basic Modeling techniques:ERD",
                "Requirements - Software Requirements:Basic Modeling techniques:Process modeling (flowcharts, activity diagrams)",
                "Requirements - Software Requirements:Requirements artifacts:Product Vision and Scope document etc",
                ...
                "Design - OOD:SOLID principles",
                "Design - OOD:Anti-patterns",
                "Design - OOD:Architectural Patterns: MVVM (.NET Desktop Profile)",
                ...
                "Design - DB Design:Optimizing the Database Design by Denormalizing",
                ...
                "Security - Java:Java SE Cryptography Architecture (JCA)",
                "Security - Java:Java Authentication and Authorization Service (JAAS)",
                "Security - Java:Java EE: Securing Applications (Enterprise, Web)",
                "Security - Java:Java EE: Programmatic and declarative security",
                "Security - Java:Java EE: Securing HTTP resources",
                "Security - Java:Spring Security: project modules",
                "Security - Java:Spring Security: Authentication Mechanisms (Basic, Digest, Remember-Me, Anonymous, OpenID, LDAP Authentication, OAuth 2.0)",
                "Security - Java:Spring Security: Authorization Architecture",
                "Security - Java:Spring Security: Domain Object Security (ACLs)",
                "Security - Java:OWASP Top 10 Security risks",
                "Security - Java:Writing firewall-friendly applications",
                "Security - Java:Protecting against canonical representation attacks",
                "Security - Java:Protecting against SQL-injection attacks",
                "Security - Java:Protecting against cross-site scripting attack",
                "Security - Java:Protecting against DoS attacks",
                "Security - Java:RSA (algorithm)",
                ...
                "Construction - Language - Java:Java 7 features:Locating Files and Directories Using Paths",
                "Construction - Language - Java:Java 7 features:Obtaining and Managing Files and Directories",
                "Construction - Language - Java:Java 7 features:Working with Filesystems in Java 7",
                "Construction - Language - Java:Java 7 features:Stream IO in Java 7",
                "Construction - Refactoring:Making Method Calls Simpler",
                "Construction - Refactoring:Dealing with Generalization",
                "Construction - Refactoring:Creation:Replace Constructors with Creation Methods",
                "Construction - Refactoring:Creation:Move Creation Knowledge to Factory",
                "Construction - Refactoring:Creation:Encapsulate Classes with Factory",
                "Construction - Refactoring:Creation:Encapsulate Composite with Builder",
                "Construction - Refactoring:Simplification:Replace Conditional Logic with Strategy",
                "Construction - Refactoring:Simplification:Replace State-Altering Conditionals with State",
                "Construction - Refactoring:Simplification:Replace Implicit Tree with Composite",
                "Construction - Refactoring:Simplification:Replace Conditional Dispatcher with Command",
                "Construction - Refactoring:Generalization:Form Template Method",
                "Construction - Refactoring:Generalization:Extract Composite",
                "Construction - Refactoring:Generalization:Replace Hard-Coded Notifications with Observer",
                "Construction - Refactoring:Generalization:Red green refactoring",
                "Construction - Concurrency - Java:Atomic Classes",
                "Construction - Concurrency - Java:Usage of ThreadLocal and InheritableThreadLocal  variables",
                "Construction - Concurrency - Java:Synchronizing a block of code with a Lock:The Lock Interface",
                "Construction - Concurrency - Java:Synchronizing a block of code with a Lock:Synchronizing data access with read/write locks",
                "Construction - Concurrency - Java:Deadlock vs Livelock",
                "Construction - Concurrency - Java:Preventing and detection of deadlocks",
                "Construction - Concurrency - Java:Lock Starvation",
                "Construction - Concurrency - Java:Advanced Synchronization Techniques:Synchronization Terms",
                "Construction - Concurrency - Java:Advanced Synchronization Techniques:Control the access to one or more shared resources with Semaphore",
                "Construction - Concurrency - Java:Advanced Synchronization Techniques:Allows a thread to wait for the finalization of multiple operations with CountDownLatch",
                "Construction - Concurrency - Java:Advanced Synchronization Techniques:The synchronization of multiple threads in a common point with CyclicBarrier",
                "Construction - Concurrency - Java:Advanced Synchronization Techniques:Interchange date between two threads with Exchanger",
                "Construction - Concurrency - Java:Advanced Synchronization Techniques:Control the execution of concurrent tasks divided in phases with Phaser",
                "Construction - Concurrency - Java:Threads and Collection Classes from java.util.concurrent package:Thread-Notification Collection Classes",
                "Construction - Concurrency - Java:Threads and Collection Classes from java.util.concurrent package:Threadsafe Collection Classes: ConcurrentHashMap, CopyOnWriteArrayList, ConcurrentLinkedQueue",
                "Construction - Concurrency - Java:Threads and Collection Classes from java.util.concurrent package:static methods of the Collections class for synchronized collections creation",
                "Construction - Concurrency - Java:Working with Thread Priorities",
                "Construction - Concurrency - Java:Organize Thread Pooling with Executors and ExecutorService",
                "Construction - Concurrency - Java:Fork/Join Framework",
                "Construction - Concurrency - Java:Daemon Threads",
